...
class Tod(pygame.sprite.Sprite):
    ...
    def __init__(self) -> None:
        ...
        for i in range(17):                                  
            ...
            self.ded = pygame.transform.scale(self.ded, (400, 400))
            #self.ded = pygame.transform.scale(self.ded(32,32))
    ...
    def powera(self):
        for identity in self.powerupa.sprites():
            if pygame.sprite.spritecollideany(identity, self.slime):
                identity.kill()
                pygame.mixer.Sound.play(self.watermelon_sound)
                self.slime.sprite.speedy += 1
                self.slime.sprite.sprunghöhe += 1
